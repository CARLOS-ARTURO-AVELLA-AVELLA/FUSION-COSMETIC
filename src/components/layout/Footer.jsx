      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300 text-sm">+57 (1) 322-3047472</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail size={18} className="text-cyan-400 flex-shrink-0" />
                <span className="text-gray-300 text-sm">info@fusion.com</span>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="border-t border-slate-700 py-12 mb-8">
          <div className="flex justify-center gap-12">
            <a href="#" target="_blank" rel="noopener noreferrer" className="bg-blue-600 hover:bg-blue-500 text-white p-4 rounded-full transition duration-300 transform hover:scale-110" title="Facebook">
              <Facebook size={40} />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="bg-pink-500 hover:bg-pink-400 text-white p-4 rounded-full transition duration-300 transform hover:scale-110" title="Instagram">
              <Instagram size={40} />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="bg-sky-500 hover:bg-sky-400 text-white p-4 rounded-full transition duration-300 transform hover:scale-110" title="Twitter">
              <Twitter size={40} />
            </a>
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white p-4 rounded-full transition duration-300 transform hover:scale-110" title="TikTok">
              <TikTokIcon />
            </a>
          </div>
        </div>
